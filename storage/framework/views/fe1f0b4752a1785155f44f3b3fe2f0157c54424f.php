                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title"><?php echo app('translator')->get('view_pages.filter_request'); ?></h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span></button>
                                    </div>
                                    <div class="modal-body text-left">
                                        <div class="request-status">
                                            <h4><?php echo app('translator')->get('view_pages.trip_status'); ?></h4>
                                            <div class="demo-radio-button">
                                                <input name="trip_status" type="radio" id="is_completed" data-val="1"
                                                    class="with-gap radio-col-green">
                                                <label for="is_completed"><?php echo app('translator')->get('view_pages.completed'); ?></label>
                                                <input name="trip_status" type="radio" id="is_cancelled" data-val="1"
                                                    class="with-gap radio-col-red">
                                                <label for="is_cancelled"><?php echo app('translator')->get('view_pages.cancelled'); ?></label>
                                                <input name="trip_status" type="radio" id="is_trip_start" data-val="0"
                                                    class="with-gap radio-col-yellow">
                                                <label for="is_trip_start"><?php echo app('translator')->get('view_pages.not_yet_started'); ?></label>
                                            </div>
                                            <h4><?php echo app('translator')->get('view_pages.paid_status'); ?></h4>
                                            <div class="demo-radio-button">
                                                <input name="is_paid" type="radio" id="paid" data-val="1"
                                                    class="with-gap radio-col-green">
                                                <label for="paid"><?php echo app('translator')->get('view_pages.paid'); ?></label>
                                                <input name="is_paid" type="radio" id="unpaid" data-val="0"
                                                    class="with-gap radio-col-red">
                                                <label for="unpaid"><?php echo app('translator')->get('view_pages.unpaid'); ?></label>
                                            </div>
                                            <h4><?php echo app('translator')->get('view_pages.payment_option'); ?></h4>
                                            <div class="demo-radio-button">
                                                <input name="payment_opt" type="radio" id="card" data-val="0"
                                                    class="with-gap radio-col-red">
                                                <label for="card"><?php echo app('translator')->get('view_pages.card'); ?></label>
                                                <input name="payment_opt" type="radio" id="cash" data-val="1"
                                                    class="with-gap radio-col-blue">
                                                <label for="cash"><?php echo app('translator')->get('view_pages.cash'); ?></label>
                                                <input name="payment_opt" type="radio" id="wallet" data-val="2"
                                                    class="with-gap radio-col-yellow">
                                                <label for="wallet"><?php echo app('translator')->get('view_pages.wallet'); ?></label>
                                                <input name="payment_opt" type="radio" id="wallet_cash" data-val="3"
                                                    class="with-gap radio-col-deep-purple">
                                                <label for="wallet_cash"><?php echo app('translator')->get('view_pages.cash_wallet'); ?></label>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tagxii-server/resources/views/admin/scheduled-rides/index.blade.php ENDPATH**/ ?>