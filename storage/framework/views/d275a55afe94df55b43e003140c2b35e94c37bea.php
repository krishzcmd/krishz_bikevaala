...
<div class="col-sm-12">
    <form  method="post" class="form-horizontal" action="<?php echo e(url('zone/update',request()->id)); ?>" enctype="multipart/form-data">
...
<?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 <option value="<?php echo e($service->id); ?>" <?php echo e($service->id == $zone->service_location_id ? 'selected' : ''); ?>><?php echo e($service->name); ?></option>
...
<input class="form-control" id="zone_name" type="text" name="zone_name" value="<?php echo e(old('name',$zone->name)); ?>" placeholder="<?php echo app('translator')->get('view_pages.enter_name'); ?>" required>
...
<option value="1" <?php echo e(1 == $zone->unit ? 'selected' : ''); ?>>Kilo-Meter</option>
<option value="2" <?php echo e(2 == $zone->unit ? 'selected' : ''); ?>>Miles</option>
</select>
</div>
</div>
</div>
...
var data= '<?php echo e($zone_coordinates); ?>';
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tagxii-server/resources/views/admin/zone/edit.blade.php ENDPATH**/ ?>