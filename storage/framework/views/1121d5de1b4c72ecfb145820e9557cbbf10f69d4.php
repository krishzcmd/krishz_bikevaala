...
<?php echo e(now()->parse($data->completed_at)->setTimezone(env('SYSTEM_DEFAULT_TIMEZONE', 'Asia/Kolkata'))->format('M j,Y - h:i A')); ?>
...
src="<?php echo e(asset('invoice/logo.png')); ?>"
alt="" class="CToWUd" />
</a> <br>
...
<img src="<?php echo e(asset('invoice/Invoice_White_line.png')); ?>"
...
<?php echo e(number_format($data->requestBill->total_amount, 2)); ?>
...
color: #707070;
">
&nbsp;&nbsp;&nbsp;<?php echo e($data->request_number); ?>&nbsp;&nbsp;&nbsp;<br />
</span>
</td>
</tr>
</tbody>
...
Thanks for ordering with us, <?php echo e($data->userDetail->name); ?>
...
<img height="50"
style="height: 50px"
src="<?php echo e(asset('invoice/Invoice_driver_default.png')); ?>"
alt=""
class="CToWUd" />
</td> -->
<td
...
For:
<?php echo e($data->userDetail->name); ?>
...
<img width="40"
style="width: 40px"
src="<?php echo e(asset('invoice/Invoice_user_icon_2x.png')); ?>"
alt=""
class="CToWUd" />
</td>
<td align="left"
...
<?php echo e($data->outstation_invoice ? $data->driver_name : $data->driverDetail->name); ?>
...
<img width="40"
style="width: 40px"
src="<?php echo e(asset('invoice/Invoice_dash_icon_2x.png')); ?>"
alt=""
class="CToWUd" />
</td>
<td align="left"
...
Total
Kms:
<?php echo e(number_format($data->total_distance, 2)); ?>
...
<img width="40"
style="width: 40px"
src="<?php echo e(asset('invoice/Invoice_time_icon_2x.png')); ?>"
alt=""
class="CToWUd" />
</td>
<td align="left"
...
<img width="38"
style="width: 38px"
src="<?php echo e($data->zoneType->vehicleType->icon ?? asset('invoice/Invoice_Micro_Icon.png')); ?>"
alt=""
class="CToWUd" />
</td>
<td align="left"
...
line-height: 16px;
">
<?php echo e($data->vehicle_type_name); ?>

- <?php echo e($data->outstation_invoice ? strtoupper($data->vehicle_number) : strtoupper($data->driverDetail->vehicle_number)); ?>
...
rel="noreferrer"><?php echo e(now()->parse($data->trip_start_time)->setTimezone(env('SYSTEM_DEFAULT_TIMEZONE', 'Asia/Kolkata'))->format('h:i A')); ?></a>
</span>
</span>
</td>
<td rowspan="2" style="
...
<img width="6"
height="84px"
src="<?php echo e(asset('invoice/Invoice_src_dest.png')); ?>"
...
rel="noreferrer"><?php echo e(now()->parse($data->completed_at)->setTimezone(env('SYSTEM_DEFAULT_TIMEZONE', 'Asia/Kolkata'))->format('h:i A')); ?></a>
</span>
</span>
</td>
<td style="
...
<img style="width: 100%"
src="<?php echo e(asset('invoice/Invoice_White_line.png')); ?>"
class="CToWUd" />
</td>
</tr>
</tbody>
...
<?php echo e($data->requestBill->base_price); ?>
...
Fare
for <br>
<?php echo e($data->requestBill->total_distance?number_format($data->requestBill->total_distance - $data->requestBill->base_distance, 2):0.00); ?>
...
<?php echo e($data->requestBill->distance_price); ?>
...
Fare
for <br>
<?php echo e($data->requestBill->total_time); ?>
...
<?php echo e($data->requestBill->time_price); ?>
...
Waiting Charge
for <br>
<?php echo e($data->requestBill->calculated_waiting_time); ?>
...
<?php echo e($data->requestBill->waiting_charge); ?>
...
<?php echo e($data->requestBill->cancellation_fee); ?>
...
<?php echo e($data->requestBill->admin_commision ?$data->requestBill->admin_commision: 0); ?>
...
<?php echo e($data->requestBill->promo_discount ?$data->requestBill->promo_discount: 0); ?>
...
<?php echo e(number_format($data->requestBill->ride_fare, 2)); ?>
...
line-height: 18px;
">
Tax <?php echo e(get_settings('service_tax')); ?> %
</td>
</tr>
</tbody>
</table>
...
<?php echo e(number_format(($data->requestBill->service_tax), 2)); ?>
...
width="20"
src="<?php echo e(asset('invoice/cash_international.png')); ?>"
alt=""
class="CToWUd" />
</td>
<td align="left"
...
$payment = 'Cash';
?>
<?php if($data->payment_opt == 1): ?>
<?php
$payment = 'Cash';
?>
<?php elseif($data->payment_opt
== 0): ?>
<?php
$payment = 'Card';
?>
...
<?php /**PATH /var/www/html/tagxii-server/resources/views/email/invoice.blade.php ENDPATH**/ ?>