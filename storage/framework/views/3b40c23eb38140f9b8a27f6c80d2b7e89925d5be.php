...
<?php echo e(number_format($data->requestBill->driver_commision, 2)); ?>
...
color: #707070;
">
&nbsp;&nbsp;&nbsp;<?php echo e($data->driver_invoice_no); ?>&nbsp;&nbsp;&nbsp;<br />
</span>
</td>
</tr>
</tbody>
...
Thanks for driving with us, <?php echo e($data->outstation_invoice ? $data->driver_name : $data->driverDetail->name); ?>
...
line-height: 16px;
">
<?php echo e($data->vehicle_type_name); ?> - <?php echo e($data->outstation_invoice ? strtoupper($data->vehicle_number) : strtoupper($data->driverDetail->vehicle_number)); ?>
...
<td
style="font-family: Arial, Helvetica, 'Helvetica Neue', sans-serif; color: #707070; font-size: 14px">
<?php echo e(number_format($data->requestBill->total_distance,2)); ?> km
</td>
</tr>
</tbody>
</table>
...
<?php echo e(number_format($data->requestBill->admin_commision, 2)); ?>
...
<?php echo e(number_format(($data->requestBill->admin_commision_sgst), 2)); ?>
...
<?php echo e(number_format($data->requestBill->additional_amount, 2)); ?>
...
<?php /**PATH /var/www/html/tagxii-server/resources/views/email/driver_invoice.blade.php ENDPATH**/ ?>