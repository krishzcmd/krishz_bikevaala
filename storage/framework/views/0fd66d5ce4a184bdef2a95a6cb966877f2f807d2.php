                      ...
                      /*image box*/     elseif ($setting_name['field']=="file") { ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-6">
                                                                ...
                                                                <button class="btn btn-primary btn-sm" type="button" onclick="$(<?php echo e($setting_name['name']); ?>).click()" id="upload">Browse</button>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tagxii-server/resources/views/admin/master/settings.blade.php ENDPATH**/ ?>