        ...
        <div class="row g-3">
                ...
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="display-4 fs-4 mb-2 font-weight-normal font-sans-serif text-warning"
                            ...
                            <?php echo e($total_drivers[0]['total']); ?></div><a class="font-weight-semi-bold fs--1 text-nowrap" href="<?php echo e(url('drivers')); ?>">See
            ...
            <div class="col-sm-6 col-md-3">
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <!--/.bg-holder-->
                    <div class="card-body position-relative">
                        <h6>Drivers Approved<span class="badge badge-soft-success rounded-pill ml-2"><?php echo e(number_format($total_drivers[0]['approve_percentage'],2)); ?>%</span>
                        </h6>
                        <div class="display-4 fs-4 mb-2 font-weight-normal font-sans-serif text-success"
                            data-countup="{&quot;endValue&quot;:58.386,&quot;decimalPlaces&quot;:2,&quot;suffix&quot;:&quot;k&quot;}">
                            <?php echo e($total_drivers[0]['approved']); ?></div><a class="font-weight-semi-bold fs--1 text-nowrap" href="<?php echo e(url('drivers')); ?>">See
                            all<span class="fa fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <!--/.bg-holder-->
                    <div class="card-body position-relative">
                        <h6>Drivers waiting for approval<span class="badge badge-soft-success rounded-pill ml-2"><?php echo e(number_format($total_drivers[0]['decline_percentage'],2)); ?>%</span>
                        </h6>
                        <div class="display-4 fs-4 mb-2 font-weight-normal font-sans-serif text-warning"
                            data-countup="{&quot;endValue&quot;:58.386,&quot;decimalPlaces&quot;:2,&quot;suffix&quot;:&quot;k&quot;}">
                            <?php echo e($total_drivers[0]['decline']); ?></div><a class="font-weight-semi-bold fs--1 text-nowrap"
                            href="<?php echo e(url('/drivers/waiting-for-approval')); ?>">See all<span class="fa fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                    </div>
                </div>
            </div>
                ...
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="display-4 fs-4 mb-2 font-weight-normal font-sans-serif text-danger"
                            data-countup="{&quot;endValue&quot;:58.386,&quot;decimalPlaces&quot;:2,&quot;suffix&quot;:&quot;k&quot;}">
                            <?php echo e($total_users); ?></div><a class="font-weight-semi-bold fs--1 text-nowrap" href="<?php echo e(url('users')); ?>">See
                            all<span class="fa fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tagxii-server/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>